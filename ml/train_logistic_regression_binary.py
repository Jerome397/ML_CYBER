...
ARTIFACTS_DIR = PROJECT_ROOT / "artifacts" / "runs" / f"logistic_regression_binary_{RUN_TIMESTAMP}"
...
def main():
    print("=" * 60)
    print("BINARY LOGISTIC REGRESSION TRAINING")
    print("=" * 60)
    ...
    print(f"\nSaved binary logistic artifacts to: {ARTIFACTS_DIR}")
