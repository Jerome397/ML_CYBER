...
from data.multiclass_loader import load_multiclass_dataset


ARTIFACTS_DIR = PROJECT_ROOT / "artifacts" / "runs" / "logistic_regression_multiclass"
...
def main():
    print("=" * 60)
    print("MULTICLASS LOGISTIC REGRESSION TRAINING")
    print("=" * 60)

    # Load official train and test
    train_data = load_multiclass_dataset("train")
    test_data = load_multiclass_dataset("test")
    ...
    # Split official train into train + validation
    ...
    print(f"\nSaved multiclass artifacts to: {ARTIFACTS_DIR}")
