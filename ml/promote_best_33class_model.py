...
RUN_DIRS = {
    "logistic_regression_33class": PROJECT_ROOT / "artifacts" / "runs" / "logistic_regression_33class",
    "random_forest_33class": PROJECT_ROOT / "artifacts" / "runs" / "random_forest_33class",
}

FINAL_DIR = PROJECT_ROOT / "artifacts" / "final_33class"
...
def main():
    print("=" * 60)
    print("PROMOTE BEST 33-CLASS MODEL")
    print("=" * 60)
    ...
    if not candidates:
        fail("No valid 33-class run folders found.")
    ...
    print("\nPromoted files into artifacts/final_33class:")
